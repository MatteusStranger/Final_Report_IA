...
\title{Detecção de CAPTCHA com Aprendizado de Máquina e Visão Computacional}
\author{%
...
\input{Relatorio/sections/introduction}
\input{Relatorio/sections/referencial_teorico}
\input{Relatorio/sections/metodologia}
\input{Relatorio/sections/testes}
\section{Conclusões}
